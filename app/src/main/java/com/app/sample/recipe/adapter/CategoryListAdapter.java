...
//        final Category c = filtered_items.get(position);
        final Category c = list_items.get(position);
        holder.name.setText(c.getName());
        holder.recipes.setText(c.getRecipes() + " Recipes");
        Picasso.with(holder.itemView.getContext()).load(c.getIcon()).into(holder.icon);
        Picasso.with(holder.itemView.getContext()).load(c.getPhoto()).into(holder.image);
